defmodule WebathnWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WebathnWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WebathnWeb.Gettext, "errors", msg, opts)
    end
  end
